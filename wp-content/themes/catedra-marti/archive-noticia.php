...
<div class="cm-container cm-section">
    <h1 class="cm-section__title"><?php esc_html_e('Noticias', 'catedra-marti'); ?></h1>
    ...
    <?php else : ?>
        <p><?php esc_html_e('No hay noticias publicadas todavía.', 'catedra-marti'); ?></p>
    <?php endif; ?>
</div>
